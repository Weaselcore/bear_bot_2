...
class LobbyModel(Base):
    ...
    last_promotion_datetime: Mapped[datetime] = mapped_column(nullable=True, default=None)
    ...
    # Bypassing the association object
...
class MemberLobbyModel(Base):
    ...
    lobby_id: Mapped[int] = mapped_column(ForeignKey("lobby.id", ondelete='cascade'), primary_key=True)
